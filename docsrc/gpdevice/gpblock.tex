...
This command is an alias for the \gpdevice{three}\gpproc{three}\gpcomp{two} previous command. Generates all the \gpdevice{three}\gpproc{three}\gpcomp{two} files.\\
