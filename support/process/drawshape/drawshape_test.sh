...
# block and flows
gpproc new -n drawshape
gpproc sethelp -v "DRAWSHAPE"
...
gpproc setinfo -n "company" -v "Institut Pascal"cd ..
gpproc setinfo -n "revision" -v "1.0"
gpproc setinfo -n "releasedate" -v "2016-10-04"
...
# visual settings
gpproc setdraw -f drawshape.svg

gpproc generate -o hdl
gpproc addfile -p hdl/drawshape.vhd -t vhdl -g hdl
gpproc addfile -p hdl/drawshape_process.vhd -t vhdl -g hdl
gpproc addfile -p hdl/drawshape_slave.vhd -t vhdl -g hdl
