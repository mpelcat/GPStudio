...
proc c {} {
  # Top level 
vlib matrix_5x5_builder_lib
  vmap matrix_5x5_builder_lib matrix_5x5_builder_lib
  vcom -93 -work matrix_5x5_builder_lib ../../src/vhdl/matrix_5x5_builder_comp.vhd
  vcom -93 -work matrix_5x5_builder_lib ../../src/vhdl/matrix_5x5_builder.vhd
	
  # Test bench
	vlib tb_lib
  vmap tb_lib tb_lib
  vcom -93 -work tb_lib ../../tb/vhdl/tb_matrix_5x5_builder.vhd
...
#-----------------------------------------------------------------------------
proc s {} {
  vsim -novopt -t 1ps tb_lib.tb_matrix_5x5_builder(behavioral)
