...
proc c {} {
  # Top level 
vlib harris_abc_to_r_lib
  vmap harris_abc_to_r_lib harris_abc_to_r_lib  
	vcom -93 -work harris_abc_to_r_lib ../../src/vhdl/harris_abc_to_r_comp.vhd
	vcom -93 -work harris_abc_to_r_lib ../../src/vhdl/harris_abc_to_r.vhd	
  # Test bench
	vlib tb_lib
  vmap tb_lib tb_lib
  vcom -93 -work tb_lib ../../tb/vhdl/tb_harris_abc_to_r.vhd
...
#-----------------------------------------------------------------------------
proc s {} {
  vsim -novopt -t 1ps tb_lib.tb_harris_abc_to_r(behavioral)
