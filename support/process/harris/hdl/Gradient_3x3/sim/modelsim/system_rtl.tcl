...
vlib gradient_3x3_lib
  vmap gradient_3x3_lib gradient_3x3_lib
  vcom -93 -work gradient_3x3_lib ../../src/vhdl/gradient_3x3_comp.vhd
  vcom -93 -work gradient_3x3_lib ../../src/vhdl/gradient_3x3.vhd
	
  # Test bench
	vlib tb_lib
  vmap tb_lib tb_lib
  vcom -93 -work tb_lib ../../tb/vhdl/tb_gradient_3x3.vhd
...
#-----------------------------------------------------------------------------
proc s {} {
  vsim -novopt -t 1ps tb_lib.tb_gradient_3x3(behavioral)
