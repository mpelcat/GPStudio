...
<io driver="arm" categ="hps" pi_size_addr_rel="" master_count="1">
	...
	<files>
		<file name="soc_system.v" path="hdl/submodules/soc_system.v" type="verilog" group="hdl" desc=""/>
		<file name="soc_system.qip" path="hdl/submodules/soc_system.qip" type="qip" group="hdl" desc=""/>
	</files>
	...
	<ports>
		...
		<port name="hps_0_hps_io_hps_io_sdio_inst_CMD" type="out" size="1" desc=""/>
		<port name="hps_0_hps_io_hps_io_sdio_inst_D0" type="out" size="1" desc=""/>
		<port name="hps_0_hps_io_hps_io_sdio_inst_D1" type="out" size="1" desc=""/>
		<port name="hps_0_hps_io_hps_io_sdio_inst_D2" type="out" size="1" desc=""/>
		<port name="hps_0_hps_io_hps_io_sdio_inst_D3" type="out" size="1" desc=""/>
	...
	<clocks>
		<clock name="clk_clk" direction="in" typical="50M" desc=""/>
	</clocks>
</io>
