#!/bin/bash
	...
	#Gyro_config
	gpdevice addparam -n gyro_config_reg -r 1 -m gyro_config.bits
	gpdevice addproperty -n gyro_config -t enum
	gpdevice addenum -n gyro_config.g0 -l "± 250 °/s" -v 0 
	gpdevice addenum -n gyro_config.g1 -l "± 500 °/s" -v 1 
	gpdevice addenum -n gyro_config.g2 -l "± 1000 °/s" -v 2 
	gpdevice addenum -n gyro_config.g3 -l "± 2000 °/s" -v 3 
	gpdevice setproperty -n gyro_config -l "Gyroscope sensibility"

	#Accel_config
	gpdevice addparam -n accel_config_reg -r 2 -m accel_config.bits
	gpdevice addproperty -n accel_config -t enum
	gpdevice addenum -n accel_config.a0 -l "± 2g" -v 0 
	gpdevice addenum -n accel_config.a1 -l "± 4g" -v 1 
	gpdevice addenum -n accel_config.a2 -l "± 8g" -v 2 
	gpdevice addenum -n accel_config.a3 -l "± 16g" -v 3 
	gpdevice setproperty -n accel_config -l "Accelerometer sensibility"
	...
	#Compass gain
	gpdevice addparam -n gain_compass_reg -r 4 -m gain_compass.bits
	gpdevice addproperty -n gain_compass -t enum
	gpdevice addenum -n gain_compass.c0 -l "± 0.88 Ga" -v 0 
	gpdevice addenum -n gain_compass.c1 -l "± 1.3 Ga" -v 1 
	gpdevice addenum -n gain_compass.c2 -l "± 1.9 Ga" -v 2 
	gpdevice addenum -n gain_compass.c3 -l "± 2.5 Ga" -v 3 
	gpdevice addenum -n gain_compass.c4 -l "± 4.0 Ga" -v 4 
	gpdevice addenum -n gain_compass.c5 -l "± 4.7 Ga" -v 5 
	gpdevice addenum -n gain_compass.c6 -l "± 5.6 Ga" -v 6 
	gpdevice addenum -n gain_compass.c7 -l "± 8.1 Ga" -v 7 
	gpdevice setproperty -n gain_compass -l "Compass sensibility"

	#Compass output rate
	gpdevice addparam -n fz_compass_reg -r 5 -m fz_compass.bits
	gpdevice addproperty -n fz_compass -t enum
	gpdevice addenum -n fz_compass.c0 -l "0.75 Hz" -v 0 
	gpdevice addenum -n fz_compass.c1 -l "1.5 Hz" -v 1 
	gpdevice addenum -n fz_compass.c2 -l "3 Hz" -v 2 
	gpdevice addenum -n fz_compass.c3 -l "7.5 Hz" -v 3 
	gpdevice addenum -n fz_compass.c4 -l "15 Hz" -v 4 
	gpdevice addenum -n fz_compass.c5 -l "30 Hz" -v 5 
	gpdevice addenum -n fz_compass.c6 -l "75 Hz" -v 6
	gpdevice setproperty -n fz_compass -l "Compass update rate"
