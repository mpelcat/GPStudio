...
<io driver="usb_cypress_CY7C68014A" size_addr_rel="4" master_count="1">
	...
	<params>
		...
		<param name="IN2_SIZE" hard="1" value="8" type="int"/> 
		...
		<param name="IN2_NBWORDS" hard="1" value="1280" type="int"/> 
		<param name="IN3_NBWORDS" hard="1" value="1280" type="int"/> 
		<param name="OUT0_SIZE" hard="1" value="16" type="int"/> 
		<param name="OUT1_SIZE" hard="1" value="8" type="int"/> 
